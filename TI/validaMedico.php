...
<?php
    ...
    inserir($conexao, $id_medico, $nome, $departamento, $senha);
  

    function inserir($conexao, $id_medico, $nome, $departamento, $senha) {
        $sql = "INSERT INTO medicos (id_medico,  nome, departamento, senha)
                values('$id_medico', '$nome', '$departamento','$senha')";
    ...
    <div class="login-container">
        ...
        <form action="validaFuncionarioCirurgia.php" method="post">
            <div class="form-group">
                <label>O Id:</label>
                <input type="text" name="id_medico" class="<?php echo $erroCampo ? 'erro' : ''; ?>" required>
            </div>
            <div class="form-group">
                <label>Nome: </label>
                <input type="text"  name="nome" class="<?php echo $erroCampo ? 'erro' : ''; ?>" required>
            </div>
            <div class="form-group">
                <label>Departamento: </label>
                <input type="text"  name="departamento" class="<?php echo $erroCampo ? 'erro' : ''; ?>" required>
            </div>
            <div class="form-group">
                <label>Senha</label>
                <input type="password" id="password" name="senha" class="<?php echo $erroCampo ? 'erro' : ''; ?>" required>
            </div>
            <h3>Esse médico já existe!</h3>
