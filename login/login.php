...
<?php
$erro = isset($_GET['numcar']) && $_GET['numcar'] == 0; // Verifica se numcar=0
?>
<?php
        ...
        <div class="form">
            <form id="loginForm" method="post" action="logando.php">
                <div class="box">
                    ...
                    <input type="text" id="numcar" name="numcar" placeholder="Número da carteira" required>
                ...
                <?php if ($erro): ?>
                    <p class="mensagem-erro">Número do cartão ou senha incorretos!</p>
                <?php endif; ?>
